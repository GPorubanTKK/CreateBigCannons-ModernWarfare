...
public class CBCCfgCannons extends ConfigBase {
	...
	public final ConfigInt maxCannonLength = i(128, 3, "maxCannonLength", Comments.maxCannonLength);
	public final ConfigFloat powderChargeSpread = f(0.5f, 0.0f, "powderChargeSpread", Comments.powderChargeSpread);
	public final ConfigFloat barrelSpreadReduction = f(2f, 0.0f, "barrelSpreadReduction", Comments.barrelSpreadReduction);
	...
	public final ConfigBool deployersCanUseLoadingTools = b(true, "deployersCanUseLoadingTools", Comments.deployersCanUseLoadingTools);
	public final ConfigInt ramRodReach = i(10, 1, "ramRodReach", Comments.ramRodReach);
	public final ConfigInt ramRodStrength = i(10, 1, "ramRodStrength", Comments.ramRodStrength);
	public final ConfigInt wormReach = i(10, 1, "wormReach", Comments.wormReach);
	public final ConfigFloat loadingToolHungerConsumption = f(1f, 0, "loadingToolHungerConsumption", Comments.loadingToolHungerConsumption);
	public final ConfigInt loadingToolCooldown = i(3, 0, "loadingToolCooldown", Comments.loadingToolCooldown);
	...
	public final ConfigBool cannonWeightAffectsCarriageSpeed = b(false, "cannonWeightAffectsCarriageSpeed");
